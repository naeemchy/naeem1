        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="table-wrapper">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$brands->brand_name}}" name="brand_name" required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <img src="{{URL::to($brands->brand_logo)}}" style="height: 60px;width: 80px">
                <input type="hidden" name="old_image" value="{{$brands->brand_logo}}">
            </div>
            </div><!-- modal-body -->
