            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="discount_price"  placeholder="Selling Price">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
      				  <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL1(this);" accept="image" required="">
      				  <span class="custom-file-control"></span>
      				  <img src="#" id="two" >
      				</label>
              </div>
