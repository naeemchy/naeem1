        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  <th class="wd-10px">Product ID</th>
                  <th class="wd-10px">Product Name</th>
                  <th class="wd-10px">Image</th>

                  <th class="wd-10px">Brand</th>
                  <th class="wd-10px">Quantity</th>
                  <th class="wd-10px">Status</th>
                  <th class="wd-10px">Action</th>
