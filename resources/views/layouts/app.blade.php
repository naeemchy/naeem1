                        ...
                        <div class="top_bar_content ml-auto">
                            ...
                            <div class="top_bar_user">
                                ...
                                <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                                        <a href="{{ route('login')}}"><div class="user_icon"><img src="{{asset('public/frontend/images/user.svg')}}" alt=""></div>Profile<i class="fas fa-chevron-down"></i></a>
                                        <ul>
            ...
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="custom_dropdown">
                                            <div class="custom_dropdown_list" >
                                                ...
                                                <ul class="custom_list clc" >
                                                    ...
                                                    <li style="background: green"><a class="clc" href="#">{{ $row->category_name }}</a></li>
                                                    @endforeach
                                                </ul>
                    ...
                    @endphp
                                        ...
                                        @else
                                        <div class="cart_price">$ {{ Cart::Subtotal() + $charge }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
