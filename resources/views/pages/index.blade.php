...
$best=DB::table('products')->where('status',1)->where('best_rated',1)->orderBy('id','desc')->limit(10)->get();
 $hot=DB::table('products')->join('brands','products.brand_id','brands.id')->select('brands.brand_name','products.*')->where('products.status',1)->where('hot_deal',1)->orderBy('id','desc')->limit(10)->get();
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                               ...
                               @foreach($hot as $row) 
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="{{ asset($row->image_one) }}" style="width: ;"></div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            @endif
                                             ...
                                             <a href="{{ URL::to('add/wishlist/'.$row->id) }}">
                                            <div class="product_fav">
                                                <li class="product_mark product_discount" style="background: green;">ADD</li>
                                            </div>
                                            </a>
                                            <ul class="product_marks">
                                                 @if($row->discount_price == NULL)
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="trends_container">
                        ...
                        <div class="trends_text"><p>Lorem ipsum dolor sit amet, consectetur adipiscing Donec et.</p></div>
                        <div class="trends_slider_nav">
                            <div class="trends_prev trends_nav" style="background: green;"><i class="fas fa-angle-left ml-auto"></i></div>
                            <div class="trends_next trends_nav" style="background: green;"><i class="fas fa-angle-right ml-auto"></i></div>
                        </div>
                    </div>
                </div>
@php
                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    ...
                                    <ul class="trends_marks">
                                     ...
                                     <a href="{{ URL::to('add/wishlist/'.$row->id) }}">      
                                       <div class="trends_fav" style="background: green;"><i>ADD</i></div>
                                    </a> 
                                </div>
                            </div>
                           @endforeach 
